...
GITHUB_RAW_CSV = "https://raw.githubusercontent.com/Limpan296/fpl-price-tracker/main/static/predictions.csv"

@app.route("/api/predictions")
def predictions_api():
    try:
        # Hämta CSV direkt från GitHub
        r = requests.get(GITHUB_RAW_CSV)
        r.raise_for_status()  # kasta fel om filen inte finns
